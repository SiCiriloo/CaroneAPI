...
const client = new Client({
  authStrategy: new LocalAuth({ clientId: 'bot-zdg-shop' }),
...
client.on('message', async msg => {
  ...
  if (msg.body !== "") {
    msg.reply('Acesse a Comunidade ZDG clincando no link http://comunidadezdg.com.br/ e aprenda como criar automações e robôs para WhatsApp mesmo que vcoê não seja programador.')
  }
